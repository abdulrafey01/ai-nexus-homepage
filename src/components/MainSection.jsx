  ...
  return (
    ...
    >
      ...
      <div className="max-lg:text-center lg:w-full flex-1 flex flex-col gap-8 max-sm:items-center">
        ...
        <label
          for="email"
          className="sm:py-4 pl-8 pr-1 border-2 border-gray-300 transition-colors duration-300  focus-within:border-[#6415ff] h-16 rounded-full flex justify-between items-center"
        >
          <input
            id="email"
          ...
          />
          <button className="px-5 sm:px-10 py-2 bg-[#6415ff] h-[50px] text-white rounded-full font-semibold hover:bg-[#4910bb]">
            Get Started
          </button>
        </label>
      </div>
